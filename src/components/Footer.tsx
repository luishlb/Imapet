...
export default function Footer() {
  ...
  return (
    <footer id="contato" className="bg-text-main text-white">
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <span className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center flex-shrink-0 group-hover:bg-primary transition-colors duration-300">
                    <WhatsAppIcon />
                  </span>
                  <span className="text-white/55 group-hover:text-white text-sm transition-colors duration-200">
                    (81) 99674-1525
                  </span>
                </a>
              </li>
              <li>
                <a
                  href="https://www.instagram.com/imapet_diagvet/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 group"
                >
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/30 text-sm">
            © {year} IMAPET. Todos os direitos reservados.
          </p>
          <p className="text-white/30 text-sm">
