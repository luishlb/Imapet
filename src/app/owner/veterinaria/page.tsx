...
export default function VeterinariaPage() {
  ...
  useEffect(() => {
    if (localStorage.getItem("owner_auth") !== "1") router.replace("/owner");
    else setAuth(true);
  }, [router]);
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="bg-white border-b border-gray-100 px-6 py-4 flex items-center gap-4 sticky top-0 z-10">
        ...
        <span className="text-sm font-semibold text-text-main">Pagamento veterinária</span>
      </header>

      <main className="max-w-3xl mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="px-6 py-5 border-b border-gray-100">
            <h1 className="font-playfair text-xl font-bold text-text-main">Calcular pagamento</h1>
